...
<p style="font-weight: bold;">
	Please also DO NOT submit an issue that you have with this project on the official TanStack Table
	repository. ONLY submit an issue there if you're sure that it's a problem with their library, and
	not this project or your own implementation.
</p>
